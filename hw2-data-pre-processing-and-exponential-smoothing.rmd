...
-   **Use the `ses()` function in R to find the optimal values of alpha and lambda, and generate forecasts for the next four months.**

Optimal values of lambda can be found by looking at the `model` element of the forecast object.
...
Our funtion returns 98,816.41. Now let's see what R returns:
